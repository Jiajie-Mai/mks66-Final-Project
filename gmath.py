...
def get_lighting(normal, view, ambient, light, symbols, reflect ):
    ...
    s = [0,0,0]
    for l in light:
        d[RED] += calculate_diffuse(light[l], r, n)[RED]
        d[GREEN] += calculate_diffuse(light[l], r, n)[GREEN]
        d[BLUE] += calculate_diffuse(light[l], r, n)[BLUE]
        s[RED] += calculate_specular(light[l], r, view, n)[RED]
        s[GREEN] += calculate_specular(light[l], r, view, n)[GREEN]
        s[BLUE] += calculate_specular(light[l], r, view, n)[BLUE]
